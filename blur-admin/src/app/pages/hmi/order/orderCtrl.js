...
//  	.controller('HMIOrderCtrl', HMICtrl)

//  	/** @ngInject */
// 	function HMIOrderCtrl($scope, toastr, HMIService, $rootScope, $location, $window, $uibModal, items, $uibModalInstance, $timeout, baConfig, layoutPaths, $element){
